...
slider.grid(row=0, column=0, columnspan=2, padx=10, pady=10, sticky='ew')
window_list_frame.grid(row=1, column=0, columnspan=2, padx=10, pady=10, sticky='nsew')
refresh_button.grid(row=2, column=0, padx=10, pady=10, sticky='ew')
reset_button.grid(row=2, column=1, padx=10, pady=10, sticky='ew')
revert_button.grid(row=3, column=0, columnspan=2, padx=10, pady=10, sticky='ew')
