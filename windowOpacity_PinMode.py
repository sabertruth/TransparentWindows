...
def on_button_click(preset):
    if seventyFivePercent_button:
        slider.set(preset)
        
def reset_single_window():
    if selected_window_hwnd:
...
revert_button = ttk.Button(root, text="Reset Single Window", command=reset_single_window)
...
seventyFivePercent_button = ttk.Button(root, text="75%", command=lambda: slider.set(75))
fiftyPercent_button = ttk.Button(root, text="50%", command=lambda: slider.set(50))
twentyFivePercent_button = ttk.Button(root, text="25%", command=lambda: slider.set(25))
...
seventyFivePercent_button.grid(row=5, column=0, padx=10, pady=10, sticky='ew')
fiftyPercent_button.grid(row=5, column=1, padx=10, pady=10, sticky='ew')
twentyFivePercent_button.grid(row=5, column=2, padx=10, pady=10, sticky='ew')
